...
const eras = [
  {
    ...
    summary: 'Leading INV team, managing one subordinate, building JARVIS Dashboard.',
    detail: 'Currently leading the INV team with one direct report (Gino). Built the JARVIS Dashboard (VBS-PS1-BAT-HTML) — a one-click automation system that reduced daily operations from 20 minutes to 3. Built OneDrive → VBS → Outlook email automation pipeline. Implementing PO Approval WatchFolder and automated email drafting.',
    metrics: [
      { label: 'VBA Hours', value: '~700' },
      { label: 'Templates', value: '727+' },
      { label: 'Team Size', value: '2' },
      { label: 'Daily Ops', value: '20→3min' },
    ],
    highlights: [
      'Built JARVIS Dashboard (VBS-PS1-BAT-HTML): one-click daily operations',
      'Automated email drafting pipeline (OneDrive → VBS → Outlook)',
      'PO Approval WatchFolder automation',
      'Team lead: managing subordinate Gino',
      'Serving multiple departments: INV, LL, COSME-DE, Yumi, GMP',
      'Maintaining 727+ active templates, 695K lines of code',
    ],
  },
  {
    year: '2025',
    ...
    summary: 'Expanded into INV team, BAT/VBS, web scraping, POS, HTML reporting.',
    detail: 'Expanded automation scope into INV department alongside existing Finance, Purchasing, and E-commerce responsibilities. Diversified into BAT, VBS, and PowerShell scripting. Built web scraping tools (Puppeteer, aiolimiter), POS systems, and HTML-based reporting. Developed task monitoring systems and search engines. 16 version releases, 82.1% VBA allocation.',
    metrics: [
      { label: 'VBA Hours', value: '1,748' },
      { label: 'Templates', value: '466+' },
      { label: 'LoC', value: '335K' },
      { label: 'Releases', value: '16' },
    ],
    highlights: [
      'Expanded into INV department — 1,748 hours dedicated',
      'Diversified tech: BAT, VBS, PowerShell, web scraping',
      'Built task monitoring systems and HTML reporting',
      'Developed search engines for internal data',
      'POS system integration and automation',
      '16 version releases across all departments',
    ],
  },
  {
    year: '2024',
    period: 'Jan–Dec 2024',
    role: 'VBA Developer — Finance, Purchasing, E-commerce',
    summary: 'Built supplier comparison system, e-commerce templates, 686 templates.',
    detail: 'First full year as dedicated VBA developer serving three departments simultaneously. Built Supplier Comparison system handling 100+ non-standardized supplier Excel files. Developed Lazada, Shopee, Zalora, Qoo10, and eBay monthly report templates. Completed 24 version releases. Averaged 80.3% VBA time allocation (1,600 hours).',
    metrics: [
      { label: 'VBA Hours', value: '1,600' },
      { label: 'Templates', value: '686' },
      { label: 'LoC', value: '670K' },
      { label: 'Releases', value: '24' },
    ],
    highlights: [
      'Supplier Comparison System: 100+ non-standardized files automated',
      'E-commerce monthly reports: Lazada, Shopee, Zalora, Qoo10, eBay',
      'Served 3 departments simultaneously (Finance, Purchasing, E-commerce)',
      '24 version releases with full SOPs and training documentation',
      '80.3% average VBA time allocation monthly',
      'Accumulated 670K lines of VBA code in production',
    ],
  },
  {
    year: '2023',
